...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/submitted-trades/submitted-trades').then((m) => m.SubmittedTrades),
    canActivate: [AuthGuard],
  },
  {
    path: 'order-basket',
  ...
  {
    path: 'cashflows', // Added
    loadComponent: () => import('./pages/cashflows/cashflows').then((m) => m.Cashflows),
    canActivate: [AuthGuard],
  },
  {
    path: '',
    redirectTo: '/position-view',
    pathMatch: 'full',
  },
];
